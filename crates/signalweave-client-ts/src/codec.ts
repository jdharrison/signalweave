...
import { unionToControlPayload } from "../generated/signalweave/protocol/v1/control-payload.js";

export const PROTOCOL_VERSION = 1;
export const FILE_IDENTIFIER = "SWP1";
...
/** Normalized, language-neutral view of a decoded Signalweave envelope. */
...
/**
 * Size-prefixed FlatBuffers framing for Signalweave envelopes.
 *
 * A frame is a 4-byte little-endian size prefix followed by the FlatBuffers
 * buffer (which carries the `SWP1` file identifier). The size prefix stores the
