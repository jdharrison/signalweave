...
import { DeliveryClass, Envelope, MessageKind } from "../generated/signalweave/protocol/v1.js";

const frame = readFileSync("../signalweave-protocol/tests/fixtures/reliable_event_v1.swp");
