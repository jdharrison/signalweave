...
//! the registry in `woven-inference-tools`.

#![forbid(unsafe_code)]

use woven_inference_core::{
...
impl Provider for DeterministicProvider {
    fn descriptor(&self) -> ProviderDescriptor {
        ProviderDescriptor {
            capability: woven_inference_core::Capability::new("language.dialogue"),
...
mod tests {
    ...
    use woven_core::{EntityId, PrincipalId};
    use woven_inference_core::{Cancellation, Capability};
